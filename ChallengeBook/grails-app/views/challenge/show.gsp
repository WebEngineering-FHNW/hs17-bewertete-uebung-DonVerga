...
<html>
    ...
    <!--
        ...
        <div id="show-challenge" class="content scaffold-show" role="main">
            ...
            <f:display bean="challenge" />
            <g:form resource="${this.challenge}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.challenge}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
